...
expected_vit_embeddings_output = torch.tensor([[[-1.3065, -2.6773,  0.4656,  0.3048],
         [ 1.6296, -0.7981,  0.7962,  0.6240],
         [-0.6772,  2.1267,  0.0272, -1.0913],
         [ 0.9102,  0.9367, -1.2523,  1.6247],
         [-0.0421, -3.0175, -2.2764,  1.4678],
         [ 0.1308, -0.1136, -0.1511,  0.4726],
         [ 0.7215,  1.8838, -1.2451, -1.5273],
         [-0.8570, -0.6231, -0.2172,  1.7160],
         [-0.4181,  0.9750, -0.0275,  1.7965],
         [-1.0103, -1.1011, -0.1475,  0.0355],
         [-1.6900,  0.2772, -1.5867,  0.1741],
         [-0.1166,  1.6922,  1.0752, -1.2407],
         [-0.4791,  0.1594, -0.9076, -0.1448],
         [-0.1092,  0.6597,  0.8571,  0.0388],
         [-2.4446,  0.6603,  0.1501, -0.6918],
         [-0.6655,  0.1628,  0.2030, -0.0805],
         [-1.1062, -1.0704,  0.6906, -0.9201]]])

expected_vit_attention_head_output = torch.tensor([[[-0.3057, -0.2883, -0.0385, -0.3913],
         [-0.1707, -0.2883, -0.1329, -0.3739],
         [-0.0918, -0.2947, -0.2247, -0.4450],
         [-0.1635, -0.3716, -0.2578, -0.5046],
         [-0.1867, -0.3760, -0.2376, -0.4871],
         [-0.2547, -0.3476, -0.1416, -0.4315],
         [-0.1646, -0.3074, -0.1715, -0.4216],
         [-0.3204, -0.3561, -0.0961, -0.4208]]])

expected_vit_attention_head_probs = torch.tensor([[[0.1822, 0.2297, 0.1163, 0.0478, 0.0577, 0.1078, 0.1321, 0.1265],
         [0.2247, 0.1409, 0.1003, 0.1264, 0.0902, 0.1044, 0.1418, 0.0714],
         [0.1810, 0.0846, 0.0869, 0.2086, 0.1329, 0.1098, 0.1203, 0.0758],
         [0.1324, 0.0872, 0.0951, 0.1576, 0.1438, 0.1305, 0.1055, 0.1477],
         [0.1430, 0.1013, 0.0986, 0.1372, 0.1288, 0.1293, 0.1103, 0.1516],
         [0.1705, 0.1618, 0.1102, 0.0811, 0.0861, 0.1206, 0.1248, 0.1449],
         [0.1898, 0.1207, 0.1006, 0.1401, 0.1094, 0.1158, 0.1307, 0.0929],
         [0.1660, 0.2131, 0.1115, 0.0475, 0.0595, 0.1095, 0.1192, 0.1736]]])

expected_vit_multi_head_attention_output = torch.tensor([[[-0.5255, -0.2484,  0.0462,  0.2298, -0.0359,  0.0301],
         [-0.4870, -0.2757,  0.1605,  0.0682, -0.0607,  0.1072],
         [-0.5198, -0.2672,  0.0672,  0.1935, -0.0666,  0.1002],
         [-0.5190, -0.2350,  0.0698,  0.2196, -0.0518,  0.0228],
         [-0.5040, -0.2316,  0.1059,  0.1714, -0.0388, -0.0018],
         [-0.5220, -0.1992,  0.0778,  0.2604, -0.0520, -0.0213],
         [-0.5178, -0.2681,  0.1024,  0.1700, -0.0725,  0.1299],
         [-0.5027, -0.2763,  0.0720,  0.1546, -0.0667,  0.0990]]])

expected_vit_multi_head_attention_probs = torch.tensor([[[[0.1894, 0.0929, 0.1413, 0.1311, 0.1236, 0.0740, 0.0987, 0.1492],
          [0.1062, 0.1165, 0.1470, 0.1255, 0.1058, 0.1135, 0.1472, 0.1382],
          [0.1235, 0.1295, 0.1198, 0.1229, 0.1266, 0.1319, 0.1237, 0.1221],
          [0.1987, 0.1210, 0.1023, 0.1145, 0.1369, 0.1050, 0.0855, 0.1360],
          [0.2169, 0.0966, 0.1253, 0.1216, 0.1243, 0.0740, 0.0862, 0.1551],
          [0.2563, 0.1424, 0.0592, 0.0906, 0.1595, 0.1276, 0.0533, 0.1111],
          [0.1005, 0.1665, 0.0899, 0.1008, 0.1184, 0.1908, 0.1217, 0.1114],
          [0.1212, 0.1005, 0.1608, 0.1368, 0.1125, 0.0926, 0.1384, 0.1372]],

         [[0.0606, 0.1404, 0.1601, 0.1161, 0.0954, 0.1167, 0.1836, 0.1271],
          [0.2414, 0.1197, 0.0881, 0.1105, 0.1368, 0.0978, 0.0887, 0.1169],
          [0.0873, 0.1223, 0.1497, 0.1294, 0.1106, 0.1153, 0.1640, 0.1214],
          [0.0808, 0.1132, 0.1461, 0.1339, 0.1174, 0.1508, 0.1366, 0.1213],
          [0.1411, 0.1115, 0.1159, 0.1299, 0.1358, 0.1413, 0.1038, 0.1206],
          [0.0735, 0.0828, 0.1472, 0.1541, 0.1275, 0.1933, 0.1138, 0.1078],
          [0.1044, 0.1403, 0.1308, 0.1174, 0.1156, 0.1241, 0.1365, 0.1309],
          [0.1173, 0.1102, 0.1303, 0.1352, 0.1286, 0.1358, 0.1231, 0.1194]]]])


expected_vit_faster_multi_head_attention_output = torch.tensor([[[-0.5702, -0.3077, -0.1240,  0.2555, -0.2090,  0.0266],
         [-0.5654, -0.4695, -0.1028, -0.0491, -0.4823,  0.1176],
         [-0.6741, -0.4859, -0.1573,  0.0786, -0.4666,  0.1036],
         [-0.6185, -0.4001, -0.1500,  0.1662, -0.3559,  0.0738],
         [-0.5373, -0.3100, -0.1471,  0.2301, -0.2528,  0.0385],
         [-0.6257, -0.4342, -0.1143,  0.0941, -0.4158,  0.1036],
         [-0.6727, -0.6023, -0.1461, -0.1021, -0.5709,  0.1978],
         [-0.6186, -0.4028, -0.1763,  0.1613, -0.3844,  0.0545]]])

expected_vit_faster_multi_head_attention_probs = torch.tensor([[[[0.0392, 0.0891, 0.0913, 0.1027, 0.0593, 0.2809, 0.2846, 0.0529],
          [0.1120, 0.1326, 0.1115, 0.1202, 0.1176, 0.1482, 0.1461, 0.1118],
          [0.1093, 0.1080, 0.1443, 0.1334, 0.1146, 0.1341, 0.1368, 0.1195],
          [0.0773, 0.0943, 0.1250, 0.1262, 0.0850, 0.2102, 0.1996, 0.0823],
          [0.0435, 0.0889, 0.0862, 0.1010, 0.0592, 0.2919, 0.2778, 0.0515],
          [0.1020, 0.0739, 0.1662, 0.1434, 0.0893, 0.1736, 0.1561, 0.0955],
          [0.2202, 0.1015, 0.1324, 0.1174, 0.1466, 0.0628, 0.0578, 0.1613],
          [0.0652, 0.1157, 0.1123, 0.1187, 0.0899, 0.2007, 0.2126, 0.0849]],

         [[0.1706, 0.1187, 0.0752, 0.1232, 0.1739, 0.1345, 0.0766, 0.1275],
          [0.1516, 0.1042, 0.0842, 0.1163, 0.0934, 0.1778, 0.2106, 0.0619],
          [0.2639, 0.1618, 0.0627, 0.0710, 0.1642, 0.0399, 0.0312, 0.2052],
          [0.2073, 0.1606, 0.0864, 0.0841, 0.1586, 0.0498, 0.0428, 0.2104],
          [0.1660, 0.1411, 0.1127, 0.1107, 0.1201, 0.1029, 0.1216, 0.1248],
          [0.1650, 0.1553, 0.1016, 0.0880, 0.1623, 0.0484, 0.0394, 0.2400],
          [0.2122, 0.1471, 0.0742, 0.0929, 0.1768, 0.0656, 0.0441, 0.1872],
          [0.2903, 0.1499, 0.0677, 0.0866, 0.1113, 0.0864, 0.1128, 0.0949]]]])
